...
export default class Checkbox extends PureComponent {
  ...
  foundation = new MDCCheckboxFoundation({
    ...
    getNativeControl: () => this.refs.nativeCb,
    forceLayout: () => this.refs.nativeCb.offsetWidth,
  ...
  componentDidMount() {
    ...
    this.foundation.setIndeterminate(this.props.indeterminate);
  ...
  componentDidUpdate() {
    if (this.refs.nativeCb) {
      this.refs.nativeCb.indeterminate = this.props.indeterminate;
    }
